module.exports = {
    GLOBAL: {
      EVERYONE: "Everyone",
      NOT_SPECIFIED: "Nothing was specified",
      PROVIDE_ARGS: "Please provide more args",
    ...
    MEMBER: {
      ...
      DM_BAN_MESSAGE: "You have been **banned** from **{guild_name}**\n**Reason**: {ban_reason}",
      DM_TEMPBAN_MESSAGE: "You have been **temp banned** from **{guild_name}**\n**Reason**: {ban_reason}\n**Time**: {time}",
      GUILD_BAN_MESSAGE:
        "{member} was been banned from the server.\nReason: **{ban_reason}**. I have also sent a DM letting the person know.",
      BOT_DATA: "Bot data does not save, therefore I cannot fetch their data",
    },
    ROLES: {
      MY_ROLE_NOT_HIGH_ENOUGH: "My role is not higher than the **{role}** role!",
    ...
    BOT_OWNER: {
      ...
      PROVIDE_TYPE: "Please provide a type. For example: add or remove",
      CANNOT_BL_OWNER: "Cannot blacklist an owner of this bot",
      CANNOT_BL_BOT: "The bot cannot be blacklisted",
      NOT_BLD: "That user is not blacklisted",
      ALREADY_BLD: "{member} is already blacklisted",
      NOT_OPTION: "**{type}** is not an option",
      BLACKLISTED: "blacklisted",
      UNBLACKLISTED: "unblacklisted",
      BLACKLISTED_SUCCESS: "{member} has been {type}",
    },
    LEVELS: {
      XP: "XP",
      LEVEL: "Level",
    ...
    MUSIC: {
      ...
      QUEUE_CLEARED: "The queue was been cleared",
      QUEUE: "Music Queue",
    ...
    ECONOMY: {
      ...
      BANK: "Bank",
      BALANCE: "Balance",
      DAILY_ERROR: "You have already collected your daily amount for today",
      WEEKLY_ERROR: "You have already collected your weekly amount for the week",
      MONTHLY_ERROR: "You have already collected your monthly amount for the month",
      YEARLY_ERROR: "You have already collected your yearly amount for the year",
      DAILY_SUCCESS: "You have collected your daily amount of **{amount}** coins",
      WEEKLY_SUCCESS: "You have collected your weekly amount of **{amount}** coins",
      MONTHLY_SUCCESS: "You have collected your monthly amount of **{amount}** coins",
      YEARLY_SUCCESS: "You have collected your yearly amount of **{amount}** coins",
      STORE_EMPTY:
      ...
      BUY_SUCCESS: "Successfully bought **{item}** for **{price}** coins",
      NOT_FOUND_STORE:
        "**{query}** wasn't found in the store, please use `{prefix}store` or `{prefix}servstore` to see all items in the store",
      ALREADY_OWN_ITEM: "You already own this item",
      PROVIDE_VALID_AMOUNT: "Please provide a valid numeric amount",
      DEPOSITED_ALL: "Successfully deposited all of your money!",
      ...
      DICE_WON: "Congrats! You won **{price}** coins",
      DICE_LOST: "You must land a **6** to get a **{price}** coins",
      ...
      MEMBER_NO_MONEY: "That user doesn't have any money, therefore you can't rob them.",
      ...
      ADDED_TO_STORE: "**{item}** has been added to the store!",
      ...
      LOST_SLOTS: "You lost! Try again.",
      MAX_BET: "max bet amount is **10,000**",
      ADDED_MONEY: "Successfully added **{amount}** to user balance",
      REMOVED_MONEY: "Successfully removed **{amount}** from user balance",
      MIN_BET: "Minimum bet of **50** is required",
      MIN_AMOUNT: "Amount must be above **49**",
    ...
    UTIL: {
      ...
      BUG_REPORTED: "Your Bug Report has been sent!",
    ...
    ADMIN: {
      ...
      WEL_CHAN_NOW: "Enabled welcome messages. The Welcome channel is now:",
      LEAV_CHAN_NOW: "Enabled leave messages. The Leave channel is now:",
      AUD_CHAN_NOW: "Enabled audit logs. The Audit logs channel is now:",
      ...
      SET_STARBOARD_CHAN: "Successfully set {channel} as the starboards channel",
    ...
    EVENTS: {
      ...
      NOT_FOUND: "Not found",
      BAN_ADD: "User Banned",
      KICK_ADD: "User Kicked",
      EXECUTED_BY: "Executed By:",
      REASON: "Reason",
      STARBOARD_MESSAGE: "{userTag}, this message is already in a starboard",
